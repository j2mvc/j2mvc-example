...
public class CartService {
	 ...
	 * @return Cart
	 */
	public Cart get(String productId,String userId) {
		String sql = "SELECT * FROM carts WHERE product_id=? and user_id=?";
		Object obj = dao.queryForObject(sql,new String[]{productId,userId});
		return obj!=null?(Cart) obj:null;
	}
	/**
	 * 查询用户购物车总数
